...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
	<h4 class="page-title color-60bfb3 bold">@lang('projects.create.title')</h4>
</div>
@endsection
...
@endif
<div class="white-box create-box">
	{!! Form::model($project, [
	'method' => 'POST',
...
<script type="text/javascript">
	...
	$('a.absolute-right, a#preview_purpose_detail_pencil').click(function() {
		var id = $(this).attr('href');
		$('html, body').animate({
			scrollTop: $(id).offset().top - parseInt($('.navbar-header').height())
		}, 1000);
	});
...
{{ Html::style('css/project.css?v=1.0.2') }}
@endpush
