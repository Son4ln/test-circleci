...
<script type="text/template" id="qq-template">
  <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop files here">
    ...
    <div class="border-all-bbb padding30 margin-center margin-bottom10">
      <div class="gray-background"></div>
      @lang('prime_projects.create.reference_text')
    </div>
    ...
    <ul class="qq-upload-list-selector qq-upload-list" aria-live="polite" aria-relevant="additions removals">
      <li>
        ...
        <button type="button" class="qq-btn qq-upload-delete-selector qq-upload-delete btn btn-danger btn-xs">削除</button>
