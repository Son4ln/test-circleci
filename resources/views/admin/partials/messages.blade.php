...
@if (!Request::ajax())
  <br>
  <form id='adminmessageform' class='form-horizontal' method='post' action='{{url('messages/filter')}}'>
...
<div class="form-group">
  <label class="col-md-2 control-label">@lang('admin.messages.readed')</label>
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-2 control-label">@lang('admin.messages.sender')</label>
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-2 control-label">@lang('admin.messages.receiver')</label>
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-2 control-label">@lang('admin.messages.title')</label>
  <div class="col-md-4">
      ...
      <div class="panel-body">
        <div class="media">
          <div class="media-left">
            ...
            {!!$message->kind != 2 ? "<br><h6>{$message->user->name}</h6>" : ""!!}
          </div>
