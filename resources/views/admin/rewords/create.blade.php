...
@section('content-header')
  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">@lang('admin.rewords.create.title')</h4>
  </div>
  <a href="{{ route('admin.payments.index', ['userId' => request()->route()->parameters['userId']]) }}"
    style="margin-right: 15px" class="pull-right">
    <button type="button" class="btn btn-primary">@lang('admin.rewords.list.title')</button>
  </a>
@endsection
...
@section('content')
  <div class="white-box">
    {!! Form::open([
      ...
      'url' => route('admin.rewords.store', ['userId' => request()->route()->parameters['userId']])
    ]) !!}
    <div class="form-group {{ $errors->has('reword') ? 'has-error' : '' }}">
      <label class="col-md-3 control-label">@lang('admin.rewords.fields.project_name')</label>
      <div class="col-md-6">
    ...
    <div class="form-group" style="margin-top: 3em;">
      <div class="col-md-6 col-md-offset-3">
        <button type="submit" class="btn btn-primary btn-lg">@lang('admin.rewords.create.submit')</button>
      </div>
    </div>
    {!! Form::close() !!}
  </div>
